...
const QUICK = [
  ...
  { key: "scanners", label: "Scanners", icon: "scan-outline", route: "/scanners" },
  { key: "voice-cmd", label: "Voice Commands", icon: "mic-circle-outline", route: "/voice-commands" },
  { key: "vault", label: "Message Vault", icon: "lock-closed-outline", route: "/vault" },
  { key: "contact-groups", label: "Contact Groups", icon: "people-circle-outline", route: "/contact-groups" },
  { key: "privacy", label: "Privacy Screen", icon: "eye-off-outline", route: "/privacy-screen" },
